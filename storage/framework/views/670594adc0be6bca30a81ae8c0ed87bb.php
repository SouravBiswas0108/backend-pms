...
<form class="" method="post" action="<?php echo e(route('admin.departments.update', encrypt($department->department_id))); ?>">
    <?php echo csrf_field(); ?>
                    ...
                    <div class="row p-0">
                        ...
                        <div class="col-6 form-group">
                            ...
                            <input type="text" class="form-control" id="dept_id" name="dept_id"
                                value="<?php echo e($department->department_id); ?>" readonly="readonly" />
                        </div>
                        <div class="col-6 form-group">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped dataTable_edit_dept" id="my-table">
                                    ...
                                    <tbody>
                                        ...
                                        <?php if(isset($departmentlist) && !empty($departmentlist) && is_array($departmentlist)): ?>

                                                                            <?php $__currentLoopData = $departmentlist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $staffs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td style="color:black;">
                                                                                                                        ...
                                                                                                                        <input type="checkbox" name="checkall[]" class="sub_chk"
                                                                                                                            value="<?php echo e(($staffs['staff_id'] != '') ? ($staffs['staff_id']) : ''); ?>"
                                                                                                                            checked="checked" />
                                                                                                                    </td>
                                                                                                                </tr>
                                            ...
                                            <?php $__currentLoopData = $departmentlist['unSelectedStafflist']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $staffsnew): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="color:black;">
                                                        ...
                                                        <input type="checkbox" name="checkall[]" class="sub_chk"
                                                            value="<?php echo e(($staffsnew['staff_id'] != '') ? ($staffsnew['staff_id']) : ''); ?>" />
                                                    </td>
                                                </tr>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php endif; ?>
                                        ...
                                        <?php if(empty($departmentlist) && empty($departmentlist)): ?>
                                            <tr class="font-style">
                                                <td colspan="6" class="text-center"><?php echo e(__('No data available in table')); ?>
                        ...
                        <input type="hidden" name="selected_staff"
                            value="<?php echo e(($alreadyselected != '') ? (implode(',', $alreadyselected)) : 'null'); ?>"
