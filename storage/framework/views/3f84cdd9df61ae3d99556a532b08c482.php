...
<?php $__env->startSection('content'); ?>
    <div class="login-form">
        ...
        <form method="POST" action="<?php echo e(route('admin.loginsubmit')); ?>" class="needs-validation" novalidate="">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="text-xs text-muted text-center">
                <a href="#" class="text-xs"><?php echo e(__('Forgot Your Password?')); ?></a>
            </div>
...
<?php echo $__env->make('admin.layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Office/backend-fmepms/backend-pms/resources/views/admin/auth/login.blade.php ENDPATH**/ ?>