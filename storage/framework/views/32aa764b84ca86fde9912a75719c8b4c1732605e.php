...
<div class="sidenav custom-sidenav" id="sidenav-main">
    <div class="sidenav-header d-flex align-items-center">
        <a style="background-color: #fff;margin: 0px 10px;border-radius: 10px;" class="navbar-brand" href="<?php echo e(route('home')); ?>">
            <img src="<?php echo e(asset(Storage::url('logo/logo-full.png'))); ?>" alt="<?php echo e(config('app.name', 'LeadGo')); ?>" class="navbar-brand-img">
        </a>
        <div class="ml-auto">
    ...
    <div class="scrollbar-inner">
        <div class="div-mega">
            <ul class="navbar-nav navbar-nav-docs">
                ...
                <?php if(Gate::check('Manage Users') || Gate::check('Manage Clients') || Gate::check('Manage Roles') || Gate::check('Manage Permissions')): ?>
                    <?php if((\Auth::user()->type == 'Owner')): ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage Users')): ?>
                            <li class="nav-item">
                                <a class="nav-link <?php echo e(request()->is('users*') ? 'active' : ''); ?>" href="<?php echo e(route('users')); ?>">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage Users')): ?>
                            <li class="nav-item">
                                <a class="nav-link " href="<?php echo e(route('department')); ?>">
                        ...
                        <?php endif; ?>
                        <li class="nav-item">
                            <a class="nav-link " href="<?php echo e(route('duties')); ?>">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage Roles')): ?>
                            <li class="nav-item">
                                <a class="nav-link <?php echo e((Request::route()->getName() == 'roles.index') ? 'active' : ''); ?>" href="<?php echo e(route('roles.index')); ?>">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage Users')): ?>
                            <li class="nav-item">
                                <a class="nav-link " href="<?php echo e(route('mpms_form')); ?>">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('System Settings')): ?>
                            <li class="nav-item">
                                <a class="nav-link <?php echo e((Request::route()->getName() == 'settings') ? 'active' : ''); ?>" href="<?php echo e(route('settings')); ?>">
                        ...
                        <?php endif; ?>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('faqlist')); ?>">
                ...
                <?php endif; ?>
                <li class="nav-item">
                    <a href="<?php echo e(route('logout')); ?>" class="nav-link dropdown-item" onclick="event.preventDefault();document.getElementById('logout-form').submit();">
...
<?php /**PATH /home/deveduco/public_html/admin/resources/views/partials/admin/navbar.blade.php ENDPATH**/ ?>