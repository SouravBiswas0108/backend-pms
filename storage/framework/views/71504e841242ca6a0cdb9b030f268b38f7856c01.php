<?php $__env->startSection('title'); ?>
    <?php echo e(__('Bottom 30 Employees by performence rating on')); ?>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped dataTable_for_user_performence_rating_by_department_bottom">
                            <thead>
                            <tr>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/deveduco/public_html/admin/resources/views/users/bottom_thirty_employees_by_performence_rating.blade.php ENDPATH**/ ?>