<?php $__env->startSection('title'); ?>
    <?php echo e(__('Employee performence rating by grade level on')); ?>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped dataTable_for_user_performence_rating_by_grade_level">
                            <thead>
                            <tr>
                            ...
                            <?php if(count($alldata) > 0): ?>
                                <?php $__currentLoopData = $alldata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alldatas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td style="color:black;"><?php echo e(($alldatas['userdetails']['grade_level']!='') ? $alldatas['userdetails']['grade_level'] : ''); ?></td>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/deveduco/public_html/admin/resources/views/users/user_performence_rating_by_grade_level.blade.php ENDPATH**/ ?>