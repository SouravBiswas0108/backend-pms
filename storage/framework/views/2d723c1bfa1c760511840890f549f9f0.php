    ...
    <div class="row">
        <div class="col-6 form-group">
            ...
            <input type="number" class="form-control emp_id_text" onkeypress="return /[0-9a-zA-Z]/i.test(event.key)"
                id="ippis_no" name="ippis_no" value="<?php echo e($user->ippis_no); ?>" />
        ...
        <div class="col-6 form-group">
            ...
            <input type="text" class="form-control" id="staff_id" name="staff_id" value="<?php echo e($user->staff_id); ?>"
                readonly="readonly" />
        </div>

        <div class="col-6 form-group">
            <label class="form-control-label" for="fname"><?php echo e(__('First Name')); ?></label>
            <input type="text" class="form-control" id="fname" name="fname" value="<?php echo e($user->F_name); ?>" />
            <span class="error" style="color:red"></span>
        </div>

        <div class="col-6 form-group">
            <label class="form-control-label" for="mid_name"><?php echo e(__('Middle Name')); ?></label>
            <input type="text" class="form-control" id="mid_name" name="mid_name" value="<?php echo e($user->M_name); ?>" />
            <span class="error" style="color:red"></span>
        </div>

        <div class="col-6 form-group">
            <label class="form-control-label" for="lname"><?php echo e(__('Last Name')); ?></label>
            <input type="text" class="form-control" id="lname" name="lname" value="<?php echo e($user->L_name); ?>" />
            <span class="error" style="color:red"></span>
        </div>
        ...
        <div class="col-6 form-group">
            ...
            <input type="text" class="form-control" id="cadre" name="cadre" value="<?php echo e($user->userDetails->cadre); ?>" />
            <span class="error" style="color:red"></span>
        </div>
        ...
        <div class="col-6 form-group" id='datetimepicker1'>
            ...
            <input type="date" class="form-control" id="date_of_current_posting" name="date_of_current_posting"
                value="<?php echo e($user->userDetails->date_of_current_posting); ?>" max="<?php echo e(date('Y-m-d')); ?>">
            <span class="error" style="color:red"></span>
        </div>
        ...
        <div class="col-6 form-group" id='datetimepicker1'>
            ...
            <input type="date" class="form-control" id="date_of_MDA_posting" name="date_of_MDA_posting"
                value="<?php echo e($user->userDetails->date_of_MDA_posting); ?>">
            <span class="error" style="color:red"></span>
        </div>
        ...
        <div class="col-6 form-group" id='datetimepicker1'>
            ...
            <input type="date" class="form-control" id="date_of_last_promotion" name="date_of_last_promotion"
                value="<?php echo e($user->userDetails->date_of_last_promotion); ?>">
            <span class="error" style="color:red"></span>
        </div>
        ...
        <div class="col-6 form-group">
            ...
            <select name="gender" class="form-control select2" id="gender">
                ...
                <option value="male" <?php if($user->userDetails->gender == 'male'): ?> selected="selected" <?php endif; ?>>Male
                </option>
                <option value="female" <?php if($user->userDetails->gender == 'female'): ?> selected="selected" <?php endif; ?>>
                    Female</option>
                <option value="others" <?php if($user->userDetails->gender == 'others'): ?> selected="selected" <?php endif; ?>>
                    Others</option>
            </select>
        ...
        <div class="col-6 form-group">
            ...
            <select name="grade_level" class="form-control select2" id="grade_level" required>
                ...
                <option value="1" <?php if($user->userDetails->grade_level == '1'): ?> selected="selected" <?php endif; ?>>1
                </option>
                <option value="2" <?php if($user->userDetails->grade_level == '2'): ?> selected="selected" <?php endif; ?>>2
                </option>
                <option value="3" <?php if($user->userDetails->grade_level == '3'): ?> selected="selected" <?php endif; ?>>3
                </option>
                <option value="4" <?php if($user->userDetails->grade_level == '4'): ?> selected="selected" <?php endif; ?>>4
                </option>
                <option value="5" <?php if($user->userDetails->grade_level == '5'): ?> selected="selected" <?php endif; ?>>5
                </option>
                <option value="6" <?php if($user->userDetails->grade_level == '6'): ?> selected="selected" <?php endif; ?>>6
                </option>
                <option value="7" <?php if($user->userDetails->grade_level == '7'): ?> selected="selected" <?php endif; ?>>7
                </option>
                <option value="8" <?php if($user->userDetails->grade_level == '8'): ?> selected="selected" <?php endif; ?>>8
                </option>
                <option value="9" <?php if($user->userDetails->grade_level == '9'): ?> selected="selected" <?php endif; ?>>9
                </option>
                <option value="10" <?php if($user->userDetails->grade_level == '10'): ?> selected="selected" <?php endif; ?>>10
                </option>
                <option value="11" <?php if($user->userDetails->grade_level == '11'): ?> selected="selected" <?php endif; ?>>11
                </option>
                <option value="12" <?php if($user->userDetails->grade_level == '12'): ?> selected="selected" <?php endif; ?>>12
                </option>
                <option value="13" <?php if($user->userDetails->grade_level == '13'): ?> selected="selected" <?php endif; ?>>13
                </option>
                <option value="14" <?php if($user->userDetails->grade_level == '14'): ?> selected="selected" <?php endif; ?>>14
                </option>
                <option value="15" <?php if($user->userDetails->grade_level == '15'): ?> selected="selected" <?php endif; ?>>15
                </option>
                <option value="16" <?php if($user->userDetails->grade_level == '16'): ?> selected="selected" <?php endif; ?>>16
                </option>
            </select>
        ...
        <div class="col-6 form-group">
            ...
            <input type="email" class="form-control" id="email" name="recovery_email"
                value="<?php echo e($user->userDetails->recovery_email); ?>" />
            <span class="error" style="color:red"></span>
        </div>

        <div class="form-group col-12 text-right">
            <input type="submit" id="save_user" value="<?php echo e(__('Update User')); ?>" class="btn-create badge-blue"
...
</form><?php /**PATH /var/www/html/Office/backend-fmepms/backend-pms/resources/views/admin/users/edit.blade.php ENDPATH**/ ?>