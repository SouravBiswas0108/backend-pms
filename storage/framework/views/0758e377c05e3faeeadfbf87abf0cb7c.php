...
<div class="row d-flex justify-content-end">
    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-12 col-12">
        <div class="all-button-box">
            <a href="<?php echo e(route('admin.departments.create')); ?>" data-title="<?php echo e(__('Create Department')); ?>"
                class="btn btn-xs btn-white btn-icon-only width-auto"><i class="fas fa-plus"></i> <?php echo e(__('Create')); ?> </a>
        </div>
    </div>
</div>
<?php $__env->stopSection(); ?>
                        ...
                        <tbody>
                            ...
                            <?php if(count($department) > 0): ?>
                                <?php $__currentLoopData = $department; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dept): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td style="color:black;"><?php echo e($dept['department_id']); ?></td>
                                        <td style="color:black;"><?php echo e($dept['department_name']); ?></td>

                                        <td class="Action">
                                            <span>

                                                <a href="<?php echo e(route('admin.departments.show', encrypt($dept['department_id']))); ?>"
                                                    class="edit-icon bg-warning">
                                                    <i class="fas fa-eye"></i></a>

                                                <a href="<?php echo e(route('admin.departments.edit',encrypt($dept['department_id']))); ?>" class="edit-icon " data-url="" data-ajax-popup=""
                                                    data-title="<?php echo e(__('Edit Department')); ?>"><i class="fas fa-pencil-alt"
                                                ...
                                                <a href="#"
                                                    class="btn btn-xs btn-white btn-icon-only width-auto edit-icon assign_staff"
                                                    data-url="" data-ajax-popup=""
                                                    data-title="<?php echo e(__('Assign Staff Department')); ?>">Assign Staff</a>
                                                <a href="#"
                                                    class="btn btn-xs btn-white btn-icon-only width-auto edit-icon assign_staff"
                                                    data-url="" data-ajax-popup=""
                                                    data-title="<?php echo e(__('Departments Staff')); ?>">Download Staffs Report</a>
