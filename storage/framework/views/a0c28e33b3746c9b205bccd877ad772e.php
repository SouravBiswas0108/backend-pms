    ...
    <div class="col align-self-center alert alert-danger alert-dismissible fade show" role="alert">
        ...
        <ul>
            <?php $__currentLoopData = Session::get('import_errors'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $failure): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li>
                    <p><?php echo e("ON SERIAL NO. "); ?> &nbsp; <?php echo e($failure->row() - 1); ?> &nbsp; <?php echo e($failure->errors()[0]); ?> </p>
                </li>
...
<div class="all-button-box row d-flex justify-content-end">
    ...
    <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
        <a href="javascript:void(0)" class="btn btn-xs btn-white btn-icon-only width-auto" data-ajax-popup="true"
            data-url="<?php echo e(route('admin.dashboard')); ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 form-group">
                                ...
                                <input type="text" class="form-control" id="staff_id" name="staff_id"
                                    value="<?php echo e($randomString); ?>" readonly="readonly" />
                            </div>
                            ...
                            <tbody id="datatable">
                                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo e($user->F_name); ?>

                                            <?php if($user->M_name): ?>
                                                <?php echo e($user->M_name); ?>

                                            <?php endif; ?>
                                            <?php if($user->L_name): ?>
                                                <?php echo e($user->L_name); ?>

                                            <?php endif; ?>
                                        </td>
                                        <td><?php echo e($user->email); ?></td>
                                        <td>Active</td>
                                        <td><?php echo e($user->userDetails->type); ?></td>
                                        <td class="action-icons">
                                            <span>
                                                <a href="<?php echo e(route('admin.users.show', ['user' => strtr(base64_encode($user->id), '+/=', '-_A')])); ?>"
