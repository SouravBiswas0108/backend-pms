...
@section('content')
    ...
    <form class="" method="post" action="{{ route('admin.departments.update',$department->department_id) }}">
        @csrf
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row p-0">
                            ...
                            <div class="col-6 form-group">
                                ...
                                <input type="text" class="form-control" id="dept_id" name="dept_id" value="{{$department->department_id }}" readonly="readonly" />
                            </div>
                            <div class="col-6 form-group">
                            ...
                            <div class="col-6 form-group">
                                ...
                                <input type="text" class="form-control" id="dept_name" name="dept_name" value="{{$department->department_name}}"/>
                            </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped dataTable_edit_dept" id="my-table">
                                        ...
                                        <tbody>
                                            ...
                                            @if(isset($departmentlist['departmentStaffAlreadySelected']) && !empty($departmentlist['departmentStaffAlreadySelected']) && is_array($departmentlist['departmentStaffAlreadySelected']))
                                            @foreach($departmentlist['departmentStaffAlreadySelected'] as $staffs)
                                            <tr>
                                                ...
                                                <td style="color:black;">
                                                    ...
                                                    @endphp
                                                    <input type="checkbox" name="checkall[]" class="sub_chk" value="{{ ($staffs['staff_id'] !='') ? ($staffs['staff_id']) : '' }}" checked="checked"/>
                                                </td>
                                            </tr>
                                            @endforeach
                                            @endif
                                            ...
                                            <tr>
                                                ...
                                                <td style="color:black;">
                                                    ...
                                                    <input type="checkbox" name="checkall[]" class="sub_chk" value="{{ ($staffsnew['staff_id'] !='') ? ($staffsnew['staff_id']) : '' }}"/>
                                                </td>
                                            </tr>
                                            @endforeach
                                            @endif
                                            ...
                                            @if(empty($departmentlist['departmentStaffAlreadySelected']) && empty($departmentlist['unSelectedStafflist']))
                                                <tr class="font-style">
