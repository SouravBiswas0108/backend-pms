...
@if($status == 'update' )
    @section('content')   
        <form method="post" action="{{ route('mpms_form.final') }}" id="finalForm"> 
            @csrf
            <div>
                            ...
                            <div class="card-body">
                                <div class="row p-0">
                                    ...
                                    <div class="col-6 form-group">
                                        ...
                                        <input type="text" class="form-mpms" id="obj_weight" name="objactives[{{$key}}][obj_weight]" value="{{ $value->obj_weight }}">
                                    </div>
                                    <div class="col-6 form-group">
                                    ...
                                    <div class="col-6 form-group">
                                        ...
                                        <input type="text" class="form-mpms" id="target" name="objactives[{{$key}}][target]" value="{{ $value->target }}">
                                    </div>
                                    <div class="col-6 form-group">
                        ...
                        <div class="card-body">
                            <div class="row p-0">
                                ...
                                <div class="col-6 form-group">
                                    ...
                                    <input type="text" class="form-mpms" id="obj_weight" name="objactives[0][obj_weight]" value="{{ old('objactives[0][obj_weight]') }}">
                                </div>
                                <div class="col-6 form-group">
                                ...
                                <div class="col-6 form-group">
                                    ...
                                    <input type="text" class="form-mpms" id="target" name="objactives[0][target]" value="{{ old('objactives[0][target]') }}">
                                </div>
                                <div class="col-6 form-group">
