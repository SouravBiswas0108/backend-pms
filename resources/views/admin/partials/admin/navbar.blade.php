            ...
            <ul class="navbar-nav navbar-nav-docs">
                ...
                @if(Gate::check('Manage Users') || Gate::check('Manage Clients') || Gate::check('Manage Roles') || Gate::check('Manage Permissions'))
                    @if((\Auth::user()->type == 'Owner'))
                        @can('Manage Users')
                            <li class="nav-item">
                                <a class="nav-link {{ request()->is('users*') ? 'active' : '' }}" href="{{route('admin.dashboard')}}">
                        ...
                        @can('Manage Roles')
                            <li class="nav-item">
                                <a class="nav-link {{ (Request::route()->getName() == 'roles.index') ? 'active' : '' }}" href="{{route('admin.dashboard')}}">
                        ...
                        @can('System Settings')
                            <li class="nav-item">
                                <a class="nav-link {{ (Request::route()->getName() == 'settings') ? 'active' : '' }}" href="{{route('admin.dashboard')}}">
                ...
                @endif
                <li class="nav-item">
                    <a href="{{ route('admin.dashboard') }}" class="nav-link dropdown-item" onclick="event.preventDefault();document.getElementById('logout-form').submit();">
